...
usbdrv/%.o: ../usbdrv/%.S
	...
	avr-gcc -x assembler-with-cpp -I/home/iam/Programs/my/MultiProg/usbdrv -I/home/iam/Programs/my/MultiProg -mmcu=atmega8 -DF_CPU=12000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
